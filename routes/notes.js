...
router.get("/org", async (req, res) => {
    ...
    res.render("inventory_org",{layout:'./inventory_base', curr_notes:resp_data, curr_info:curr_info});
});

router.get("/usr", (req, res) => {
    res.render("inventory_usr",{layout:'./inventory_base'});
});
